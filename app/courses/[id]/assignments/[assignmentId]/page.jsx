              ...
              {assignment.type === 'mcq' ? (
                ...
                <div>
                  ...
                  {assignment.questions && assignment.questions.map((question, qIndex) => {
                    ...
                    return (
                      <div key={qIndex} className="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-200 shadow-sm">
                        {/* Question Header */}
                        <div className="mb-4">
                              ...
                              >
                                <div className="flex items-center space-x-4">
                                  <input
                                    ...
                                    className={`${
                                      hasMultipleAnswers ? 'w-5 h-5 rounded' : 'w-5 h-5'
                                    } text-cyan-600 focus:ring-cyan-500 focus:ring-2 ${
